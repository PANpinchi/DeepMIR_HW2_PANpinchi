...
def separate_and_evaluate(
    ...
    separator = utils.load_separator(
        ...
        use_griffinlim=use_griffinlim,
        remove_lstm=remove_lstm
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument("--use_griffinlim", action="store_true", default=False, help="Use Griffin-Lim")
        ...
        scores_list = list(
            pool.imap_unordered(
                func=functools.partial(
                    ...
                    device=device,
                    use_griffinlim=args.use_griffinlim
                ),
                iterable=mus.tracks,
                chunksize=1,
            )
