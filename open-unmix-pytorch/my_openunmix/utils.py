...
def load_target_models(targets, model_str_or_path="umxl", device="cpu", pretrained=True, remove_lstm=False):
    """Core model loader
...
def load_separator(
    ...
    if model_path.exists():
        ...
        target_models = load_target_models(targets=targets,
